...
import type { GroupBase, HighlightTextOptions, LoadOptions } from "../../src";
import { AsyncPaginate } from "../../src";

import type { StoryProps } from "../types";

type HighlightSearchTermStoryProps = StoryProps & {
...
export function HighlightSearchTerm(
	props: HighlightSearchTermStoryProps,
): ReactElement {
	...
	return (
		...
		>
			<AsyncPaginate
				{...props}
				highlightSearchTerm={props?.highlightSearchTerm ?? true}
				value={value}
